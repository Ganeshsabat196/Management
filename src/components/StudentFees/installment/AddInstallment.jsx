...
// api
import { addStudentsFees } from "../../Api/StudentsFees";
...
const AddInstallment = () => {
  ...
  console.log(location.state.student_id, location.state.student_name);
  ...
  // updating the add installment form data on changing the values
  ...
  const submitForm = async (e) => {
    ...
    const response = await addStudentsFees(data);
    ...
    <>
      <div className="page-wrapper">
        <div className="content container-fluid">
          <PageHeader pageTitle="Add Installment" />
